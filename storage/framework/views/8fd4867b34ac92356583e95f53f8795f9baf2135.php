<div class="row grid">
    <div class="col-md-3 col-sm-3 col-xs-6 text-center content item">
        <?php if(isset($data[$key])): ?>
            <img class="img-thumbnail cover" src="<?php echo e(asset($data[$key]['cover'])); ?>" >
    ...
    <div class="col-md-3 col-sm-3 col-xs-6 text-center content item">
        <?php if(isset($data[$key+1])): ?>
            <img class="img-thumbnail cover" src="<?php echo e(asset($data[$key+1]['cover'])); ?>" >
    ...
    <div class="col-md-3 col-sm-3 col-xs-6 text-center content item">
        <?php if(isset($data[$key+2])): ?>
            <img class="img-thumbnail cover" src="<?php echo e(asset($data[$key+2]['cover'])); ?>" >
    ...
    <div class="col-md-3 col-sm-3 col-xs-6 text-center content item">
        <?php if(isset($data[$key+3])): ?>
            <img class="img-thumbnail cover" src="<?php echo e(asset($data[$key+3]['cover'])); ?>" >
